...
var orderStatus = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(statusArray) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function orderStatus(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
if (orderStatsForm) orderStatsForm.addEventListener('submit', function (e) {
  ...
  (0, _status.orderStatus)(statusArray);
}); // // togglePassword
// if (togglePassword) {
