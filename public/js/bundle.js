...
var updateProd = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(bondlet, bondleg, bonda4, bonda5, glosa6, glosa5, gloslet, glosa4, lasa3, lasa4, lasa5) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Updated product stocks!');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function updateProd(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11) {
    return _ref.apply(this, arguments);
  };
}();
...
var prodForm = document.getElementById('.upd--prods');
...
if (prodForm) prodForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var bondlet = document.getElementById('bondlet').value;
  var bondleg = document.getElementById('bondleg').value;
  var bonda4 = document.getElementById('bonda4').value;
  var bonda5 = document.getElementById('bonda5').value;
  var glosa6 = document.getElementById('glosa6').value;
  var glosa5 = document.getElementById('glosa5').value;
  var gloslet = document.getElementById('gloslet').value;
  var glosa4 = document.getElementById('glosa4').value;
  var lasa3 = document.getElementById('lasa3').value;
  var lasa4 = document.getElementById('lasa4').value;
  var lasa5 = document.getElementById('lasa5').value;
  (0, _products.updateProd)(bondlet, bondleg, bonda4, bonda5, glosa6, glosa5, gloslet, glosa4, lasa3, lasa4, lasa5);
}); // // togglePassword
// if (togglePassword) {
