...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(User, type) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, contact, email, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Please verify the email sent to your account');
              window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteAcc.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteAcc = void 0;
...
var deleteAcc = /*#__PURE__*/function () {
  ...
  return function deleteAcc() {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteAcc = deleteAcc;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"uploadFile.js":[function(require,module,exports) {
"use strict";
...
var uploadFile = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(datafile) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"forgotPw.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.forgotPw = void 0;
...
var forgotPw = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Sent to your email!");
            }
  ...
  return function forgotPw(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.forgotPw = forgotPw;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"resetPw.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetPw = void 0;
...
var resetPw = /*#__PURE__*/function () {
  ...
  return function resetPw(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.resetPw = resetPw;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"emailVerif.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.emailVerif = void 0;
...
var emailVerif = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 200) {
              (0, _alerts.showAlert)('success', 'Email verified!');
              window.setTimeout(function () {
                location.assign('/login');
              }, 1500);
            }
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            console.log(_context.t0.response);
            (0, _alerts.showAlert)('error', 'Verifying email failed! Try again.');
  ...
  return function emailVerif() {
    return _ref.apply(this, arguments);
  };
}();

exports.emailVerif = emailVerif;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"status.js":[function(require,module,exports) {
"use strict";
...
var orderStatus = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(statusArray, statsArray) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            // });
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Updated orders successfully!');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function orderStatus(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.orderStatus = orderStatus;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../utils/api.js":[function(require,module,exports) {
...
module.exports = api;
},{"axios":"../../node_modules/axios/index.js"}],"dl.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            location.assign("/api/v1/files/download/".concat(fileId));
...
},{"../../utils/api":"../../utils/api.js","axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"payment.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'File uploaded successfully!');
              window.setTimeout(function () {
                location.assign('/documents');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateProducts.js":[function(require,module,exports) {
"use strict";
...
var updateProducts = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(plainArray, glossyArray, laserArray) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function updateProducts(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateProducts = updateProducts;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"getProducts.js":[function(require,module,exports) {
"use strict";
...
var _forgotPw = require("./forgotPw");

var _resetPw = require("./resetPw");

var _emailVerif = require("./emailVerif");
...
var _updateProducts = require("./updateProducts");
...
var deleteBtn = document.querySelector('.delete--acc');
var uploadFileForm = document.querySelector('.form-file-data');
var forgotPwBtn = document.querySelector('.forgot--pass');
var resetPwBtn = document.querySelector('.reset--pass');
...
var prodForm = document.querySelector('.upd--prods');
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _register.register)(name, contact, email, password, passwordConfirm);
  });
}

if (deleteBtn) deleteBtn.addEventListener('click', _deleteAcc.deleteAcc);
if (verifyBtn) verifyBtn.addEventListener('click', _emailVerif.emailVerif);
if (downloadBtn) downloadBtn.addEventListener('click', _dl.download); // if (downloadBtn)
...
if (uploadFileForm) uploadFileForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  ...
  form.append('summaryPrice', document.getElementById('summaryPrice').value);
...
if (forgotPwBtn) forgotPwBtn.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  (0, _forgotPw.forgotPw)(email);
});
if (resetPwBtn) resetPwBtn.addEventListener('submit', function (e) {
  e.preventDefault();
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('passwordConfirm').value;
  (0, _resetPw.resetPw)(password, passwordConfirm);
});
if (orderStatsForm) orderStatsForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var statusArray = [];
  var statsArray = [];
  var index = 0;
  ...
  (0, _status.orderStatus)(statusArray, statsArray);
});
if (prodForm) prodForm.addEventListener('submit', function (e) {
  ...
  while (true) {
    var price = document.getElementById("plainPrice-".concat(index));
    var additional = document.getElementById("plainAdditional-".concat(index));
    var stocks = document.getElementById("plainStocks-".concat(index));
    if (!price) break;
    plainArray = [].concat(_toConsumableArray(plainArray), [{
      price: price.value,
  ...
  while (true) {
    var _price = document.getElementById("glossyPrice-".concat(index));

    var _additional = document.getElementById("glossyAdditional-".concat(index));

    var _stocks = document.getElementById("glossyStocks-".concat(index));

    if (!_price) break;
    glossyArray = [].concat(_toConsumableArray(glossyArray), [{
      price: _price.value,
      additional: _additional.value,
      stocks: _stocks.value
    }]);
    index++;
  }
  ...
  while (true) {
    var _price2 = document.getElementById("laserPrice-".concat(index));

    var _additional2 = document.getElementById("laserAdditional-".concat(index));

    var _stocks2 = document.getElementById("laserStocks-".concat(index));

    if (!_price2) break;
    laserArray = [].concat(_toConsumableArray(laserArray), [{
      price: _price2.value,
      additional: _additional2.value,
      stocks: _stocks2.value
    }]);
    index++;
  }

  (0, _updateProducts.updateProducts)(plainArray, glossyArray, laserArray);
}); // // togglePassword
// if (togglePassword) {
...
if (typeSelect) typeSelect.addEventListener('change', function (e) {
  ...
  var filtered = products.filter(function (product) {
    return product.type === typeSelect.value;
  });
...
if (colorSelect) colorSelect.addEventListener('change', function (e) {
  return updatePrice();
});
if (sideSelect) sideSelect.addEventListener('change', function (e) {
  var summarySide = document.getElementById('summarySide');
  summarySide.textContent = sideSelect.value === 'front' ? 'Front' : 'Front & Back';
});
if (filenameField) filenameField.addEventListener('input', function (e) {
  var summaryFilename = document.getElementById('summaryFilename');
  summaryFilename.textContent = filenameField.value;
});
if (copiesField) copiesField.addEventListener('input', function (e) {
  updatePrice();
  var summaryCopies = document.getElementById('summaryCopies');
  summaryCopies.textContent = "x".concat(copiesField.value);
});
if (pagesField) pagesField.addEventListener('input', function (e) {
  updatePrice();
  var summaryPages = document.getElementById('summaryPages');
...
var updatePrice = function updatePrice() {
  ...
  var pages = pagesField.value;
  var copies = copiesField.value;
